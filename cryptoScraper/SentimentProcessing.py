...
#Resource used: https://www.digitalocean.com/community/tutorials/how-to-perform-sentiment-analysis-in-python-3-using-the-natural-language-toolkit-nltk
class SentimentProcessing():
    ...
    def getSentimentScore(self, post):
        custom_tokens = self.remove_noise(word_tokenize(post))
